...
This tap is tested with all actively supported [Python](https://devguide.python.org/versions/#supported-versions) and [PostgreSQL](https://www.postgresql.org/support/versioning/) versions. At the time of writing, this includes Python 3.10 through 3.13 and PostgreSQL 14 through 18.
...
| stream_options.<stream_name>.custom_where_clauses | False    | None                         | Additional custom where condition when extracting data                                                                                                                                                                                                                                                   |
